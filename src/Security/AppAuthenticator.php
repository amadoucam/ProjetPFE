...
class AppAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    ...
    {
        return 'security_login' === $request->attributes->get('home')
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        if (!$user) {
            // fail authentication with a custom error Email could not be found.
            throw new CustomUserMessageAuthenticationException('Email non Enregistrer');
        }
